...
func TestNew(t *testing.T) {
	...
	assert.NotNil(t, s)
	assert.Len(t, s.menu, 9, "should have 9 top-level categories")
	assert.Len(t, s.currentItems, 9, "currentItems should start with root menu")
...
func TestGoBack(t *testing.T) {
	...
	assert.Len(t, s.currentItems, 9, "should be back at root menu")
}
